                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                <h3 class="text-center title-login font-weight-bold">List User</h3>
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td>
                                                        <a href="view_user.php?id=<?php echo $r['id_user']; ?>" class="btn btn-success btn-sm">View</a>
                                                        </button>
                                                        <a href="del_user.php?id=<?php echo $r['id_user']; ?>" class="btn btn-danger btn-sm" name="hapus_user">Delete</a>
                                                        </button>
                                                      </td>
                                                    </tr>
                                                    <?php
