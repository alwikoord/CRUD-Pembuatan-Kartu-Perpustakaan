                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="text-center title-login font-weight-bold">Update User</h3>
                                    <br>
                                        <div class="form-group" >
                                            <input type="text" class="form-control" id="validationServerUsername" name="id_user" readonly placeholder="Id User" value="<?php echo $r['id_user']; ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <input type="text" class="form-control" id="validationServerUsername" name="nama_user" placeholder="Nama" value="<?php echo $r['nama_user']; ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <input type="text" class="form-control" id="validationServerUsername" name="password" placeholder="Password" value="<?php echo $r['password']; ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleFormControlFile1">Masukkan Foto Anda</label>
                                            <input type="file" class="form-control-file" id="exampleFormControlFile1" name="foto" value="<?php echo "<img src='img/$r[foto]'/>"?>" required>
                                        </div>
